...
export class JokerComposer extends Composer<IBotContext> {
  ...
  private async handleTerebinder(ctx: CommandContext): Promise<void> {
    ...
    const conclusions = [
      ...
      "Твоя судьба теперь предопределена. Но это не точно.",
      "Если предсказание не сбудется, значит, ты живёшь в другой вселенной.",
      "Теребиндер использовал все свои магические силы. Перезарядка через 24 часа.",
      "Это предсказание самоуничтожится через 5... 4... а, не умеет оно самоуничтожаться.",
    ];
