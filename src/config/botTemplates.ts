export type BotTemplates = typeof botTemplates;
...
export const botTemplates = {
  ...
  musicGame: {
    listPlayers: (players: string) => [`Всего участников: ${players}`],
    noTracks: [
    ...
    resetGame: ["Игра окончена."],
  },
  rounds: {
    noMoreRounds: [
      "Да, да, да, да... Кажется, мы закончились раундами.",
